    ...
    <div>
      ...
      <AnimatedSection className="py-12 sm:py-16 lg:py-20 bg-primary-cream" delay={0.1}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className={`${isRTL ? 'md:order-1' : ''} relative h-64 sm:h-80 lg:h-96 bg-accent-tan rounded-2xl overflow-hidden mx-auto md:mx-0 w-full max-w-md md:max-w-none`}>
              <Image
      ...
      <AnimatedSection className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-green-dark to-green-light text-white texture-overlay" delay={0.05}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href={`/${lang}/green-points`} className="inline-block px-6 sm:px-8 py-3 sm:py-4 bg-gold text-brown-dark rounded-lg font-bold text-base sm:text-lg hover:scale-105 transition-transform duration-300">
      ...
      <AnimatedSection className="py-12 sm:py-16 lg:py-20 bg-primary-cream" delay={0.05}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 max-w-4xl mx-auto">
            {[1, 2, 3, 4].map((i) => (
          ...
          <Link href={`/${lang}/partners`} className="btn-secondary inline-block">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {[
              ...
              <AnimatedItem key={index} index={index}>
                <div className="flex items-start gap-3 p-4 sm:p-5 bg-white rounded-lg text-center sm:text-left justify-center sm:justify-start">
      ...
      <AnimatedSection className="py-12 sm:py-16 lg:py-20 texture-overlay bg-primary-bg" delay={0.05}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href={`/${lang}/media`} className="btn-primary inline-block">
